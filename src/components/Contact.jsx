...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/AbdullahRagaab',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/abdullah-ragabb',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'https://abdullahragab460@gmail.com',
      icon: (
          ...
          <div className="space-y-4">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                className="flex items-center space-x-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group"
              >
